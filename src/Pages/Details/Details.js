                                            ...
                                            currentProduct.weight.map((item, index) => {
                                                return (
                                                    <li className='list-inline-item'>
                                                        <a href=" " className={`tag ${activeSize === index ? 'active' : ''}`} onClick={() => isActive(index)}>{item}g</a>
                                                    </li>
                                                )
                                            })
                                        }
                                    ...
                                    <ul className='list list-inline mb-0 ps-4'>
                                        {
                                            currentProduct.RAM.map((RAM, index) => {
                                                return (
                                                    <li className='list-inline-item'>
                                                        <a href=" " className={`tag ${activeSize === index ? 'active' : ''}`} onClick={() => isActive(index)}>{RAM} GB</a>
                                                    </li>
                                                )
                                            })
                                        }
                                    ...
                                    <ul className='list list-inline mb-0 ps-4'>
                                        {
                                            currentProduct.SIZE.map((SIZE, index) => {
                                                return (
                                                    <li className='list-inline-item'>
                                                        <a href=" " className={`tag ${activeSize === index ? 'active' : ''}`} onClick={() => isActive(index)}>{SIZE}</a>
                                                    </li>
                                                )
                                            })
                                        }
                                                        ...
                                                        <div className='card p-4 reviewsCard flex-row' key={index}>
                                                            <div className='col-md-1 image'>
                                                                <div className='rounded-circle'>
                                                                    <img src={Proimg1} alt="Proimg1" width={100} />
                                                                </div>
